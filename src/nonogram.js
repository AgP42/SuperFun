 ...
 * and the player reconstructs it. Win = every clue satisfied. Every shipped
 * picture is verified to be *uniquely* solvable (verify_nonograms.js).
 *
 * CommonJS — runs under Node (tests) and the RN/Hermes runtime.
 */
'use strict';

// '#' = filled, '.' = empty. Each entry: {name, rows:[...]} — square (size×size).
var PICTURES = {
  5: [
    {name: 'heart', rows: ['.#.#.', '#####', '#####', '.###.', '..#..']},
    {name: 'cross', rows: ['..#..', '..#..', '#####', '..#..', '..#..']},
